...
1. The model has 536,285 parameters in total, of which 178,761 are trainable. <br>
2. There are no non-trainable parameters, and the optimizer uses 357,524 parameters. <br>
3. The total model size is approximately 2.05 MB, making it compact yet effective for stock price prediction. <br>

![image alt](https://github.com/SundeepChaluvadi/Stock-Price-Prediction-Model/blob/0c5682f29d1417add6091530d7002b5e58b20c9d/Images/Params.png)
